...
class Experiment(Config):
    ...
    ################################
    # Dataset name
    ds_name: Literal['emnist', 'fmnist', 'coil-20', 'coil-100', 'voc', 'rgbd', 'Hdigit','leaves','prokaryotic','synthetic3d','cifar10','cifar100','YoutubeFace_sel_fea','Caltech-2V','Caltech-3V','Caltech-4V','Caltech-5V','CCV','Fashion','MNIST_USPS','COIL20-3v','Mfeat'] = None
    # Image size.
    img_size: int = 28
    ################################
    #    Clustering Module         #
